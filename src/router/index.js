...
const routes = [
  ...
  },
  {
    path: '/draw',
    name: 'DrawPage',
    component: () => import(/* webpackChunkName: "draw" */ '@/views/DrawPage/DrawPage.vue'),
    meta: {
      layout: 'default',
      requiresAuth: true // Change this to false in order login is not required
    }
  ...
  {
    path: '/history/:id',
    name: 'DisplayDrawPage',
    component: () => import(/* webpackChunkName: "history" */ '@/views/DisplayDrawPage/DisplayDrawPage.vue'),
    meta: {
      layout: 'default',
      requiresAuth: true // Change this to false in order login is not required
    }
